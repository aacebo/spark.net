...
public partial class ChatPrompt<TOptions>
{
    ...
    public ChatPrompt<TOptions> Function(string name, string? description, ISchema parameters, Func<object?, Task<object?>> handler)
    {
        Functions.Add(new Function(name, description, parameters, handler));
        return this;
    }

    public ChatPrompt<TOptions> Function<T>(string name, string? description, ISchema parameters, Func<T, Task<object?>> handler)
    {
