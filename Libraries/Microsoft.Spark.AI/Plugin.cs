...
public interface IPlugin
{
    ...
    public Task<IMessage> OnBeforeSend<TOptions>(IPrompt<TOptions> prompt, IMessage message, TOptions? options = default);
    ...
    /// <param name="options">the model options</param>
    /// <returns>the transformed message</returns>
    public Task<IMessage> OnAfterSend<TOptions>(IPrompt<TOptions> prompt, IMessage message, TOptions? options = default);
}